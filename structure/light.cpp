...
/**********************   Fim das Definições da Classe AmbientLight  **************************/


/**********************************************************************************************/
/******************** Ínicio das Definições da Classe DirectionalLight ************************/
/**********************************************************************************************/
...
Vec4 DirectionalLight::calculateColor(Vec4 pit, Vec4 n,Vec4 viewer, Material *m,Vec4 pos)
{
...
/********************   Fim das Definições da Classe DirectionalLight  ************************/
...
Vec4 PontualLight::calculateColor(Vec4 pit, Vec4 n,Vec4 viewer, Material *m,Vec4 position)
{
...
/**********************   Fim das Definições da Classe PontualLight  **************************/


/**********************************************************************************************/
/************************ Ínicio das Definições da Classe SpotLight ***************************/
/**********************************************************************************************/
...
float SpotLight::isInDualConeSpot(Vec4 pit)
{
    ...
    Vec4 d(direction_light->x(),direction_light->y(),direction_light->z());
    Vec4 v = (pit-p).unitary();
    float angle_inner = 0.2*angle_light;
    float cosOuter = cos(angle_light*M_PI/180.0);
    float cosInner = cos(angle_inner*M_PI/180.0);
    float cosDirection = v*d;
...
SpotLight::SpotLight()
{
    ...
    factor_attenuation = new Vec4(1.0,0.0,0.0,0.0); //constante, linear, quadratico
    double   angle_light = 45.0;           //para luz do tipo spot
    double   expoent_light = 1.0;          //fator de atenuação
...
Vec4 SpotLight::calculateColor(Vec4 pit, Vec4 n,Vec4 viewer, Material *m,Vec4 pos)
{
    ...
    Vec4 color = ambiente+((Diffuse+especular))*isInDualConeSpot(pit)*pow(direction*(l*-1),expoent_light)*attenuation((position-viewer).module());
    return color;
}
...
/************************   Fim das Definições da Classe SpotLight  ***************************/
